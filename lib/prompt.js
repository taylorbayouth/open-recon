...
Operating rules:
  ...
  - Don't repeat work. Check "What you've done so far" before each action: a region
    ...
    to captured content either. select_text(save:true) already persists it — don't also
    call save_text; get_images/get_files gives a URL — call save_file, don't screenshot
    or navigate there.
