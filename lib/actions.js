...
const ACTIONS = {
  ...
  type: {
    ...
    description: 'Focus the element and type text into it. Typing alone does NOT submit — a search box or form stays put until submitted. Pass submit:true to press Enter after typing (the usual way to run a search or submit a single-field form). Replaces any existing field value by default; pass clear:false to append instead.',
  },
  scroll: {
    requiresRef: false,
