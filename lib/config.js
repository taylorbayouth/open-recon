...
const DEFAULTS = {
  ...
  loop: {
    ...
    maxSameDirectionScrolls: 3,  // warn when same scroll direction repeats this many times on a page
  },

  // "Moment of silence" — a loop-triggered reflection turn (lib/reflect.js).
