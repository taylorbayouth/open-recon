...
that mixes two kinds of line:
  ...
  - Unreadable regions, marked [unreadable] — a rendered graphic (chart, map,
    canvas, scanned or alt-less image, CAPTCHA) whose content is not in the
    listing as text. [unreadable] is a label, not a ref: you cannot click or
    select it. If its content matters to the task, scroll it into view (use its
    coordinates) and take_screenshot to read it; otherwise ignore it.
