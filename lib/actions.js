...
const ACTIONS = {
  ...
  take_screenshot: {
    ...
    changesPage: false,
    idempotentRead: true,
    description: 'Capture the page; vision describes and saves it. With no ref, captures the whole visible viewport. Pass a ref (@e, @t, or an @r unreadable region) to crop tightly to that element — best for reading a chart, diagram, canvas, scanned image, or CAPTCHA. Not for images that have a URL — use save_file instead. Optional hint focuses the description.',
  },
  get_images: {
    requiresRef: false,
    args: {},
