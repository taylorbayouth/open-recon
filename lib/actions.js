...
const ACTIONS = {
  ...
  selectText: {
    ...
    refType: ['e', 't'],
    args: {},
    description: 'Select (highlight) the full text of the node identified by ref — a text node (@t…) like a heading or paragraph, or an element (@e…). Drags the cursor from the start to the end of the node, like a mouse click-drag. Selects the whole node, not a sub-phrase.',
  },
  done: {
    requiresRef: false,
    args: { result: 'string?' },
