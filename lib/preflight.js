...
//   2. driver       browser-input binary present — offers download or build
...
const BIN_PATH     = path.resolve(ROOT, 'native', 'macos', 'browser-input', 'bin', 'browser-input');
const BUILD_SCRIPT = path.resolve(ROOT, 'native', 'macos', 'browser-input', 'build.sh');
