...
// browser browser-agent didn't launch. PID-based, mirroring launch()'s own
...
module.exports = { launch, isRunning, isOwnChrome, findFreePort, getTarget, isControllablePageTarget, mainChromePid, DEFAULT_PROFILE_DIR };
