...
// the scratchpad contents verbatim. Ready to hand to the user or feed to another
// model — the bulk text lived on disk during the run, never in the agent's own
// context, and only gets stitched together here at the very end.
function buildReport(runArtifact, events, scratchpad) {
